...
KindEditor.plugin('video', function (K) {
    var self = this, name = 'video', lang = self.lang(name + '.'),
        ...
        fieldAccept = K.undef(self.filedAccept, 'video/mp4'),
    ...
    self.plugin.video = {
        edit: function () {
            var html = [
                ...
                '<input class="ke-input-text" type="text" id="keUrl" name="url" value="" style="width:218px;" /> &nbsp;',
            ...
            var dialog = self.createDialog({
                    ...
                    yesBtn: {
                        ...
                        click: function (e) {
                            ...
                            var html = '<p><video src="' + url + '" controls="controls" loop="true" autostart="' + isAutoStart + '" width="' + width + '" height="' + height + '"></video>&nbsp; &nbsp; &nbsp;&nbsp;&nbsp;<br/></p>';
