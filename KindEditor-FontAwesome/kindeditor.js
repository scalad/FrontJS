    ...
    _extend(KUploadButton, {
        init: function (options) {
            var self = this,
                ...
                fieldAccept = options.fieldAccept,
                url = options.url || '',
                title = button.val(),
			...
			'</span>',
			'<input type="file" class="ke-upload-file" name="' + fieldName + '" accept="' + fieldAccept + '" tabindex="-1" />',
        ...
        create: function () {
            ...
            K.each(self.items, function (i, name) {
                if (name == '|') {
                    ...
                    //htmlList.push('<span class="ke-toolbar-icon ke-toolbar-icon-url ke-icon-' + name + '" unselectable="on"></span></span>');  liuxuanqiang modify
